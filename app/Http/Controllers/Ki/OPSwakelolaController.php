...
//MODEL//
use App\Model\Ki\OPSwakelolaModel;

class OPSwakelolaController extends MYController
{
    ...
    public function read(Request $request) {
        $queryBuilder = DB::table('tbl_pelaksanaan_op_swakelola')->select('*');
    ...
    public function store(Request $request) {
        $validate = Validator::make($request->all(), [
            ...
            'swakelola_non_fisik_jumlah' => 'required',
            'swakelola_non_fisik_dana' => 'required',
            'swakelola_fisik_jumlah' => 'required',
            'swakelola_fisik_dana' => 'required',
            ...
            'kegiatan_wajib_balai_jumlah' => 'required',
            'kegiatan_wajib_balai_dana' => 'required',
            ...
            'swakelola_non_fisik_jumlah' => 'Jumlah Swakelola Non Fisik',
            'swakelola_non_fisik_dana' => 'Dana Swakelola Non Fisik',
            'swakelola_fisik_jumlah' => 'Jumlah Swakelola Fisik',
            'swakelola_fisik_dana' => 'Dana Swakelola Dana',
            ...
            'kegiatan_wajib_balai_jumlah' => 'Jumlah Kegiatan Wajib Balai',
            'kegiatan_wajib_balai_dana' => 'Dana Kegiatan Wajib Balai',
    ...
    public function update(Request $request) {
        ...
        $data = OPSwakelolaModel::findOrfail($request->id);
    ...
    public function destroy($id) {
        $data = OPSwakelolaModel::findOrfail($id)->delete();
