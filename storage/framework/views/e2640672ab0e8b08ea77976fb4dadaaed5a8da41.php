<form id="form-submit">
    <div class="row">
        ...
        <div class="form-group col-lg-12 form-hide">
            Catatan : <label for=""><?php echo e(isset($data->komitmen_mr->verifikasi_catatan) ? $data->komitmen_mr->verifikasi_catatan : '-'); ?></label>
        </div>
...
</form><?php /**PATH D:\Codes\Programs\github reza\projek-sikimr\resources\views/formulir/komitmen-mr/komitmen-mr-kirim.blade.php ENDPATH**/ ?>