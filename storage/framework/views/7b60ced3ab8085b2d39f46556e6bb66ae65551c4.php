    ...
    <div class="col-sm-12">
        <div class="callout callout-warning">
            <p>Syarat : minimal harus diisi Pernyataan Risiko yang terdiri dari
                <?php echo e(isset($data->komitmen_mr->level) && $data->komitmen_mr->level == 'UPR-T1' ? 4 : 3); ?> Kategori
                Risiko</p>
        </div>
    </div>
</div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-sm-12 form-hide">
                                            ...
                                            <select name="resiko_kegiatan_tahap" id="resiko_kegiatan_tahap"
                                                class="form-control select2" required>
                                                <option value="">- Pilih -</option>
                                                <?php $__currentLoopData = $data->tahap; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($item->id_tahap_kegiatan); ?>"><?php echo e($item->tahap); ?>
                                        ...
                                        <div class="form-group col-sm-12 form-hide linkup-teknis">
                                            ...
                                            <select name="resiko_kegiatan_lingkup_balai"
                                                ...
                                                required>
                                                <option value="">- Pilih -</option>
                                                <?php $__currentLoopData = $data->balai; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($item->id_balai_teknik); ?>">
                                                        <?php echo e($item->balai_teknik); ?>
                                        ...
                                        <div class="form-group col-sm-12 form-hide linkup-non_teknis">
                                            ...
                                            <select name="resiko_kegiatan_lingkup" id="resiko_kegiatan_lingkup"
                                                class="form-control select2" required>
                                                <option value="">- Pilih -</option>
                                                <?php $__currentLoopData = $data->lingkup; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($item->id_lingkup_risiko); ?>">
                                                        <?php echo e($item->lingkup_risiko); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                        <div class="form-group col-sm-12 form-hide">
                                            ...
                                            <select name="resiko_kegiatan_kategori" id="resiko_kegiatan_kategori"
                                                class="form-control select2" required>
                                                <option value="">- Pilih -</option>
                                                <?php $__currentLoopData = $data->kategori; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($item->id_kategori_risiko); ?>">
                                                        <?php echo e($item->id_kategori_risiko . '. ' . $item->kategori); ?>
                                        ...
                                        <div class="form-group col-sm-12 form-hide">
                                            ...
                                            <select name="resiko_kegiatan_sumber" id="resiko_kegiatan_sumber"
                                                class="form-control select2" required>
                                                <option value="">- Pilih -</option>
                                                <?php $__currentLoopData = $data->sumber_risiko; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($item->id_sumber_risiko); ?>">
                                                        <?php echo e($item->sumber_risiko); ?>
                                        ...
                                        <div class="form-group col-sm-12 form-hide">
                                            ...
                                            <select name="resiko_list_dampak" id="resiko_list_dampak"
                                                class="form-control select2" required>
                                                <option value="">- Pilih -</option>
                                                <?php $__currentLoopData = $data->dampak; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($item->id_dampak); ?>">
                                                        <?php echo e($item->id_dampak . '. ' . $item->dampak); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                        <div class="form-group col-sm-12 form-hide">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-sm-12 form-hide">
                                            ...
                                            <select name="resiko_penilaian_kemungkinan"
                                                ...
                                                required>
                                                <option value="">- Pilih -</option>
                                                <?php $__currentLoopData = $data->kriteria_kemungkinan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($item->id_kriteria_kemungkinan); ?>">
                                                        <?php echo e($item->level_kemungkinan . '- Nilai : ' . $item->nilai); ?>
                                        ...
                                        <div class="form-group col-sm-12 form-hide">
                                            ...
                                            <select name="resiko_penilaian_dampak" id="resiko_penilaian_dampak"
                                                class="form-control select2" required>
                                                <option value="">- Pilih -</option>
                                                <?php $__currentLoopData = $data->kriteria_dampak; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($item->id_kriteria_dampak); ?>">
                                                        <?php echo e($item->dampak .
                                                            '-
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            Nilai : ' .
                                                            $item->nilai); ?>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-sm-12 form-hide">
                                            ...
                                            <select id="resiko_pengendalian_memadai"
                                                ...
                                                <option value=""></option>
                                                <?php $__currentLoopData = $data->memadai; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($item->id); ?>">
                                                        <?php echo e($item->memadai_belum); ?>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-sm-12 form-hide">
                                            ...
                                            <select name="resiko_respon" id="resiko_respon"
                                                class="form-control select2" required>
                                                <option value="">- Pilih -</option>
                                                <?php $__currentLoopData = $data->respon; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($item->id_respon_risiko); ?>">
                                                        <?php echo e($item->id_respon_risiko . '. ' . $item->respon_risiko); ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-sm-12 form-hide">
                                            ...
                                            <select name="resiko_alokasi[]" id="resiko_alokasi"
                                                ...
                                                <?php $__currentLoopData = $data->alokasi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($item->id_alokasi); ?>"><?php echo e($item->alokasi); ?>
                        ...
                        <div class="col-lg-12">
                            <table class="table table-bordered datatable" style="width: 100%">
                                ...
                                <tbody id="list-risiko">
                                    <?php $__currentLoopData = $data->risiko_lain; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo e($item->resiko_pernyataan); ?></td>
                                            <th><?php echo e($item->tahap); ?>

                                            <td><?php echo e($item->kategori); ?></td>
                                            <td><?php echo e($item->resiko_kegiatan_penyebab); ?></td>
                                            <td><?php echo e($item->resiko_kegiatan_dampak); ?></td>
                                            <td><?php echo e($item->resiko_pengendalian_nilai); ?></td>
                                            <td><?php echo e($item->resiko_prioritas); ?></td>
                                            <td> <button type="button" class="btn-pilih"
                                                    data-data="<?php echo e(json_encode($item)); ?>">Pilih</button> </td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </tbody>
                            </table>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        ...
        $(document).ready(function() {
            ...
            var sasaran_kegiatan = <?php echo json_encode($data->sasaran->toArray()); ?>;
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\Codes\Programs\github reza\projek-sikimr\resources\views/formulir/komitmen-mr/komitmen-mr-resiko.blade.php ENDPATH**/ ?>