        ...
        <div class="container">
            <div class="row my-5">
                ...
                <div class="col-md-6 mx-auto text-end aos-item" data-aos="fade-right">
                    <a href="<?php echo e(route('Berita')); ?>"class="text-primary icon-move-right">lihat selengkapnya<i
            ...
            <div class="row">
                <?php $__currentLoopData = $news->sortByDesc('created_at'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-lg-2 col-sm-6 <?php echo e($key == 0 ? '' : ''); ?>">
    ...
    <section class="py-3 aos-all" id="profile">
        <div class="container">
            ...
            <div class="row my-5">
                ...
                <div class="col-md-6 mx-auto text-end aos-item" data-aos="fade-right">
                    <a href="<?php echo e(route('Profil')); ?>"class="text-primary icon-move-right">lihat selengkapnya<i
                            class="fas fa-arrow-right text-sm ms-1"></i></a>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-6 px-3 aos-item" data-aos="fade-right">
                    <img src="<?php echo e(asset('storage/dashboard/fotoorganisasi.png')); ?>" alt="img-blur-shadow"
                        ...
                        <div class="col-md-12">
                            <div class="p-3 info-horizontal">
                                <div class="icon icon-shape  bg-gradient-primary shadow-primary text-center">
                                    <a href="<?php echo e(asset('/storage/dashboard/PP60Tahun2008_SPIP.pdf')); ?>" target="_blank"><i
                            ...
                            <div class="p-3 info-horizontal">
                                <div class="icon icon-shape  bg-gradient-primary shadow-primary text-center">
                                    <a href="<?php echo e(asset('/storage/dashboard/Perpres Nomor 18 Tahun 2020.pdf')); ?>"
                            ...
                            <div class="p-3 info-horizontal">
                                <div class="icon icon-shape  bg-gradient-primary shadow-primary text-center">
                                    <a href="<?php echo e(asset('/storage/dashboard/PermenPUPR20-2018.pdf')); ?>" target="_blank"><i
                                            class="fas fa-file opacity-10"></i></a>
                                </div>
                                <div class="description ps-3">
                            ...
                            <div class="p-3 info-horizontal">
                                <div class="icon icon-shape  bg-gradient-primary shadow-primary text-center">
                                    <a href="<?php echo e(asset('/storage/dashboard/Permen PUPR Nomor 13 Tahun 2020.pdf')); ?>"
                                        target="_blank"><i class="fas fa-file opacity-10"></i></a>
                                </div>
                                <div class="description ps-3">
                            ...
                            <div class="p-3 info-horizontal">
                                <div class="icon icon-shape  bg-gradient-primary shadow-primary text-center">
                                    <a href="<?php echo e(asset('/storage/dashboard/Permen PUPR Nomor 16 Tahun 2020.pdf')); ?>"
...
<?php echo $__env->make('Home.layouts.layouthome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Codes\Programs\sikimr\projek-sikimr\resources\views/Home/pages/home.blade.php ENDPATH**/ ?>