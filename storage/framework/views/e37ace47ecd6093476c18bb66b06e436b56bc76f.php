...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        <?php if(auth()->user()->level == 'UPR-T1'): ?>
                    ...
                    <div class="box-body">
                        ...
                        <table class="table table-mr">
                            ...
                            <tbody class="table-mr-body">
                                <?php $__currentLoopData = $data->tingkat_unit; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td>1</td>
                                        <td><?php echo e($item['tingkat']); ?></td>
                                        <td>
                                            <a href="<?php echo e(route('detail', ['unit' => $item['param']])); ?>">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <select name="tgl-pengadaan-banding1" id="tgl-pengadaan-banding1"
                                            ...
                                            <?php $__currentLoopData = $data->tgl_backup; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tgl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($tgl->tgl_backup); ?>"><?php echo e($tgl->tgl_backup); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                    <div class="col-sm-6">
                                    ...
                                    <div class="col-xs-12 col-sm-5">
                                        <div class='input-group date' id='datetimepicker-tahun-status_progress_pekerjaan'>
                                            <input type='text' id="tahun-status_progress_pekerjaan"
                                                class="form-control" value="<?php echo e(now()->format('Y')); ?>" />
                                            <span class="input-group-addon">
                                                <span class="glyphicon glyphicon-calendar"></span>
                                            </span>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-12 form-hide">
                                        <select name="status_progress_pekerjaan" id="status_progress_pekerjaan"
                                            class="form-control select2">
                                            <?php $__currentLoopData = $data->tgl_backup_profile; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tgl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($tgl->tanggal_backup); ?>"><?php echo e($tgl->tanggal_backup); ?>
                        ...
                        <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class='input-group date' id='datetimepicker-perijinan-start'>
                                            <input type='text' id="perijinan-start" class="form-control"
                                                value="<?php echo e(now()->firstOfMonth()->format('Y-m-d')); ?>" />
                                            <span class="input-group-addon">
                                                <span class="glyphicon glyphicon-calendar"></span>
                                            </span>
                                        </div>
                            ...
                            <div class="col-sm-6">
                                ...
                                <select name="perijinan-upt" id="perijinan-upt" class="form-control select2">
                                    ...
                                    <?php $__currentLoopData = $data->upt_perizinan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $upt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option><?php echo e($upt->nama_balai); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <select name="perijinan-table-upt" id="perijinan-table-upt" class="form-control select2">
                                    <option value="">ALL</option>
                                    <?php $__currentLoopData = $data->upt_permohonan_izin; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $upt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option><?php echo e($upt->nama_balai); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        ...
                        <p>*) apabila tidak sesuai, harap update pada menu <a
                                href="<?php echo e(url('ki/permohonan-izin')); ?>">permohonan perizinan</a></p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-6 col-xs-12">
                <div class="row">
                    ...
                    <!--                        <input type='text' id="perizinan-terlambat-start" class="form-control" value="<?php echo e(now()->firstOfMonth()->format('Y-m-d')); ?>"/>-->
                    <!--                        <span class="input-group-addon">-->
                    <!--                        <span class="glyphicon glyphicon-calendar"></span>-->
                    <!--                        </span>-->
                    <!--                     </div>-->
                    ...
                    <!--                        <input type='text' id="perizinan-terlambat-end" class="form-control" value="<?php echo e(now()->format('Y-m-d')); ?>"/>-->
                    <!--                        <span class="input-group-addon">-->
                    <!--                        <span class="glyphicon glyphicon-calendar"></span>-->
                    <!--                        </span>-->
                    <!--                     </div>-->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <select name="rekap-table-upt" id="rekap-table-upt"
                                                ...
                                                <?php $__currentLoopData = $data->satker_pengaduan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $satker): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option><?php echo e($satker->pemilik_resiko_satker); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                    </div>
                                                                                                                                                                                                    ...
                                                                                                                                                                                                    <div class="row">
                                                                                                                                                                                                        <div class="col-sm-6">
                                                                                                                                                                                                            <div class='input-group date' id='datetimepicker-pengaduan-upt-start'>
                                                                                                                                                                                                                <input type='text' id="pengaduan-upt-start" class="form-control" value="<?php echo e(now()->firstOfMonth()->format('Y-m-d')); ?>"/>
                                                                                                                                                                                                                <span class="input-group-addon">
                                                                                                                                                                                                                <span class="glyphicon glyphicon-calendar"></span>
                                                                                                                                                                                                                </span>
                                                                                                                                                                                                             </div>
                                                                                                                                                                                                        ...
                                                                                                                                                                                                        <div class="col-sm-6">
                                                                                                                                                                                                            <div class='input-group date' id='datetimepicker-pengaduan-upt-end'>
                                                                                                                                                                                                                <input type='text' id="pengaduan-upt-end" class="form-control" value="<?php echo e(now()->format('Y-m-d')); ?>"/>
                                                                                                                                                                                                                <span class="input-group-addon">
                                                                                                                                                                                                                <span class="glyphicon glyphicon-calendar"></span>
                                                                                                                                                                                                                </span>
                                                                                                                                                                                                             </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <select name="integritas-batas-waktu-upt" id="integritas-batas-waktu-upt"
                                    class="form-control select2">
                                    <option value="">ALL</option>
                                    <?php $__currentLoopData = $data->satker_pengaduan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $upt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option><?php echo e($upt->pemilik_resiko_satker); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>
        ...
        <?php elseif(auth()->user()->name == 'Developer'): ?>
            <!--Manajemen risiko(label)-->
            <div class="col-sm-12">
                <div class="box">
                    <div class="box-header with-border; label label-primary">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <select name="tgl-pengadaan-banding1" id="tgl-pengadaan-banding1"
                                            class="form-control select2">
                                            <?php $__currentLoopData = $data->tgl_backup; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tgl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($tgl->tgl_backup); ?>"><?php echo e($tgl->tgl_backup); ?>
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-12 form-hide">
                                        <select name="status_progress_pekerjaan" id="status_progress_pekerjaan"
                                            class="form-control select2">
                                            <?php $__currentLoopData = $data->tgl_backup_profile; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tgl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($tgl->tanggal_backup); ?>">
                                                    <?php echo e($tgl->tanggal_backup); ?>
    ...
    <script>
        ...
        const urlData = '<?php echo e(url('home/tablePerijinan')); ?>';
        const urlDataB = '<?php echo e(url('home/tableRekapPengaduanBalai')); ?>';
        const urlDataC = '<?php echo e(url('home/tableBalaiPengaduanTerbanyak')); ?>';
    ...
    <!-- <?php $__currentLoopData = $data->map; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <?php if($item->lat && $item->long): ?>
    <script>
        // var lat = <?php echo e($item->lat); ?>

        // var long = <?php echo e($item->long); ?>

        // // var tempat = <?php echo e($item->Tempat); ?>;
        // console.log(lat,long)
        L.marker([<?php echo e($item->lat); ?>, <?php echo e($item->long); ?>], {
            icon: blueIcon
        }).bindPopup('<?php echo e($item->Tempat); ?>').addTo(map);
    </script>
    <?php endif; ?>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> -->
    </div>
...
<?php echo $__env->make('layouts.layout_menu_all', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Codes\Programs\Backend\Laravel\projek-sikimr-personal\resources\views/home_index.blade.php ENDPATH**/ ?>