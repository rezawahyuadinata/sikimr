        ...
        <div class="col-md-3">
            ...
            <div class="box box-primary">
                <div class="box-body box-profile">
                    ...
                    <?php endif; ?>
                    <h3 class="profile-username text-center"><?php echo e($data->user->name); ?></h3>
                    <p class="text-muted text-center"><?php echo e($data->user->pengguna_kategori->pengguna_kategori_nama); ?></p>
                </div>
            </div>
            <div class="box box-primary">
                    ...
                    <div class="active tab-pane" id="account">
                        <form class="form-horizontal" id="form-account">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="name" name="name" placeholder="Name" value="<?php echo e($data->user->name); ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="username" name="username" placeholder="Username" value="<?php echo e($data->user->username); ?>">
                                </div>
                            </div>
                            <div class="form-group">
...
<script>
    var action_account = '<?php echo e(route("profile.update_account")); ?>';
    var action_security = '<?php echo e(route("profile.update_security")); ?>';
</script>
<script>
...
<?php echo $__env->make('layouts.modul', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Codes\Programs\sikimr\projek-sikimr\resources\views/profile.blade.php ENDPATH**/ ?>