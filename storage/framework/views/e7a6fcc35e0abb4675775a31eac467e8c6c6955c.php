...
<div class="row">
    <div class="col-lg-12">
        <?php if($data->user->level == 'UPR-T3' || $data->user->level == 'PPK'): ?>
        ...
        <?php elseif($data->user->level == 'UPR-T2' && $data->user->unit != 'Balai'): ?>
            <table id="table-sasaran" class="display table table-bordered table-hover" width="100%">
                <thead>
                    <tr>
                        <th data-orderable="false" style="text-align: center;">Tingkat</th>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                            ...
                            <div class="form-group col-sm-12 form-hide">
                                ...
                                <select name="kegiatan_id" id="kegiatan_id" class="form-control select2">
                                    ...
                                    <?php $__currentLoopData = $data->kegiatan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($item->ID); ?>" data-kode="<?php echo e($item->kode_kegiatan); ?>">
                        ...
                        <?php elseif($data->user->level == 'UPR-T2' && $data->user->unit != 'Balai'): ?>
                            <input type="hidden" name="unit" id="unit" value="<?php echo e($data->user->unit); ?>">
                            <div class="form-group col-sm-12 form-hide">
                                <label for="kegiatan_id">Sasaran Kegiatan</label>
                                <select name="kegiatan_id" id="kegiatan_id" class="form-control select2">
                                    <option value="">- Pilih -</option>
                                    <?php $__currentLoopData = $data->kegiatan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($item->ID); ?>" data-kode="<?php echo e($item->kode_kegiatan); ?>">
                                            <?php echo e($item->kode_kegiatan); ?> - <?php echo e($item->NAMA); ?>
                        ...
                        <?php else: ?>
                            ...
                            <div class="form-group col-sm-12 form-hide">
                                ...
                                <select name="program_id" id="program_id" class="form-control select2">
                                    <option value="">- Pilih -</option>
                                    <?php $__currentLoopData = $data->program; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($item->ID); ?>"><?php echo e($item->SASARAN); ?> </option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            <div class="form-group col-sm-12 form-hide">
                            ...
                            <div class="form-group col-sm-12 form-hide">
                                ...
                                <select name="kegiatan_id" id="kegiatan_id" class="form-control select2">
                                    ...
                                    <?php $__currentLoopData = $data->kegiatan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($item->ID); ?>" data-kode="<?php echo e($item->kode_kegiatan); ?>">
                                            <?php echo e($item->kode_kegiatan); ?> - <?php echo e($item->NAMA); ?> </option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            <div class="form-group col-sm-12 form-hide">
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\Codes\Programs\github reza\projek-sikimr\resources\views/formulir/komitmen-mr/komitmen-mr-sasaran.blade.php ENDPATH**/ ?>