                        ...
                        <table class="table table-bordered" width="100%" cellspacing="0">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ isset($data->tinjauan_mr->komitmen_mr) ? $data->tinjauan_mr->komitmen_mr->mr_nomor : '-' }}
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width: 25%">Tanggal Dokumen Komitmen</td>
                                    <td>{{ isset($data->tinjauan_mr->komitmen_mr) ? $data->tinjauan_mr->komitmen_mr->mr_tanggal : '-' }}
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="form-group col-sm-2 form-hide">
                                    Tahun
                                    <select name="tinjauan_tahun" id="tinjauan_tahun"
