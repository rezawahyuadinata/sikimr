                        ...
                        <table class="table table-bordered" width="100%" cellspacing="0">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ isset($data->pemantauan_mr->verifikasi_catatan) ?
                                        $data->pemantauan_mr->verifikasi_catatan : '-' }}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-lg-12 table-responsive">
                            <table id="table-pemantauan_detail" class="table table-bordered table-hover" style="width: 100%;">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    @foreach ($data->pemantauan_detail as $item)
                                        <tr>
                                            ...
                                            <td> {!! $item->pemantauan_inovasi_file ? '<a href="'.url("/storage/uploads/mr")."/".$item->pemantauan_inovasi_file.'" target="_blank">Lihat file </a> ' : '' !!}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <label for="">2. Tinjauan Atas Risiko Baru atau Masalah Yang Belum Teridentifikasi</label>
                        </div>
                        <div class="col-lg-12 table-responsive">
                    ...
                    <form id="form-submit">
                        <input type="hidden" name="pemantauan_id" value="{{ $data->pemantauan_mr->pemantauan_id }}">
                        <div class="row">
                            ...
                            <div class="form-group col-lg-2 form-hide">
                                <div class="radio">
                                    <label for="aktif0">
                                        <input type="radio" required name="verifikasi" id="aktif0" value="0">
                                        Tidak terverifikasi
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="form-group col-lg-3 form-hide">
                                <div class="radio">
                                    <label for="aktif1">
                                        <input type="radio" required name="verifikasi" id="aktif1" value="1">
                                        Terverifikasi
                                    </label>
                                </div>
                            </div>
