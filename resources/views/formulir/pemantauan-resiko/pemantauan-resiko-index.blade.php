                        ...
                        <tbody>
                            <tr>
                                <td style="width: 25%">Nomor Dokumen Tinjauan Atas Risiko Baru atau Masalah yang Belum
                                    Teridentifikasi</td>
                                <td>{{ isset($data->pemantauan_resiko) ?
                                    $data->pemantauan_resiko->pemantauan_resiko_nomor : '-' }}</td>
                            </tr>
                            <tr>
                                <td style="width: 25%">Tanggal Dokumen</td>
                                <td>{{ isset($data->pemantauan_resiko) ?
                                    $data->pemantauan_resiko->pemantauan_resiko_tanggal : '-' }}</td>
                            </tr>
                            <tr>
                                <td style="width: 25%">Nomor Dokumen Komitmen</td>
                                <td>{{ isset($data->pemantauan_resiko->komitmen_mr) ?
                                    $data->pemantauan_resiko->komitmen_mr->mr_nomor : '-' }}</td>
                            </tr>
                            <tr>
                                <td style="width: 25%">Tanggal Dokumen Komitmen</td>
                                <td>{{ isset($data->pemantauan_resiko->komitmen_mr) ?
                                    $data->pemantauan_resiko->komitmen_mr->mr_tanggal : '-' }}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
