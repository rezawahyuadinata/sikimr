                            ...
                            <table class="table table-bordered" width="100%" cellspacing="0">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ isset($data->komitmen_mr) ? AppHelper::status($data->komitmen_mr->verifikasi) : '-' }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 25%">Catatan Verifikasi</td>
                                        <td>{{ isset($data->komitmen_mr->verifikasi_catatan) ? $data->komitmen_mr->verifikasi_catatan : '-' }}
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
