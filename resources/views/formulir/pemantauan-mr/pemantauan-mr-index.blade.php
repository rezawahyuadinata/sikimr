                    ...
                    <table class="table table-bordered" style="width: 100%;" cellspacing="0">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ isset($data->pemantauan_mr->komitmen_mr) ?
                                    $data->pemantauan_mr->komitmen_mr->mr_nomor : '-' }}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
    ...
    <div class="col-sm-12">
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                ...
                <li><a href="#tab_b" data-toggle="tab">TINJAUAN ATAS RISIKO BARU ATAU MASALAH YANG BELUM TERIDENTIFIKASI</a></li>
            ...
            <div class="tab-content">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 table-responsive">
                                            <table id="table-pemantauan_detail" class="display table table-bordered table-hover" style="width: 100%;">
                                                <thead>
                                                    <tr>
                ...
                <div class="tab-pane" id="tab_b">
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-lg-12 table-responsive">
                                <table id="table-tinjauan_detail" class="display table table-bordered table-hover" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            <th data-orderable="false">No</th>
                ...
                <div class="tab-pane" id="tab_c">
                    ...
                    <div class="row">
                        <div class="col-lg-12 table-responsive">
                            <table id="table-pemantauan_resiko_detail" class="display table table-bordered table-hover" style="width: 100%;">
                                <thead>
                                    <tr>
                        ...
                        <form id="form-submit">
                            <div class="row">
                                <div class="form-group col-lg-3 form-hide">
                                    ...
                                    <div class="radio">
                                        <label for="aktif0">
                                            <input type="radio" name="pemantauan_status" id="aktif0" value="0">
                                            Draft
                                        </label>
                                    </div>
                                    <div class="radio">
                                        <label for="aktif1">
                                            <input type="radio" name="pemantauan_status" id="aktif1" value="1">
                                            Kirim
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-lg-12 form-hide">
                                    Catatan : <label for="">{{ isset($data->pemantauan_mr->verifikasi_catatan) ? $data->pemantauan_mr->verifikasi_catatan : '-' }}</label>
                                </div>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12 form-hide">
                            ...
                            <input type="date" name="pemantauan_tanggal" id="pemantauan_tanggal" class="form-control"
...
@if (isset($data->pemantauan_mr))
    <div class="modal fade" id="modal-pemantauan_detail" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"
        data-backdrop="static">
        <div class="modal-dialog modal-lg">
            <form class="form" id="form-pemantauan_detail">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="modal-title" id="modal-pemantauan_detail-title">Pemantauan Inovasi Pengendalian </h3>
                    </div>
                    <div class="modal-body">
                        <div class="row">
                            <input type="hidden" class="form-control" name="pemantauan_detail_id" id="pemantauan_detail_id" required>
                            <input type="hidden" class="form-control" name="inovasi_id" id="inovasi_id" required>
                            <div class="form-group col-sm-12 form-hide">
                                <label for="resiko_id">Pernyataan Risiko</label>
                                <select name="resiko_id" id="resiko_id" class="form-control select2" required readonly="readonly">
                                    <option value="">- Pilih -</option>
                                    @foreach ($data->resiko as $item)
                                    <option value="{{ $item->id }}" data-resiko_inovasi="{{ $item }}">{{ $item->resiko_kode.' - '. $item->resiko_pernyataan}}</option>
                                    @endforeach
                                </select>
                            </div>
                            {{-- update --}}
                            <div class="form-group col-sm-12 form-hide">
                                ...
                                <input name="penyebab_resiko" id="penyebab_resiko" class="form-control" rows="5" readonly>
                            </div>
                            <div class="form-group col-sm-12 form-hide">
                                <label for="respon_risiko">Respon Risiko</label>
                                <input name="respon_risiko" id="respon_risiko" class="form-control" rows="5" readonly>
                            </div>
                            <div class="form-group col-sm-12 form-hide">
                                <label for="inovasi_pengendalian">Inovasi Pengendalian</label>
                                <input name="inovasi_pengendalian" id="inovasi_pengendalian" class="form-control" rows="5"
                                    readonly>
                            </div>
                            {{-- end update --}}
                            <div class="form-group col-sm-12 form-hide">
                                <label for="pemantauan_penanggung_jawab">Penanggung Jawab</label>
                                <textarea name="pemantauan_penanggung_jawab" id="pemantauan_penanggung_jawab"
                                    class="form-control" rows="5" readonly></textarea>
                            </div>
                            <div class="form-group col-sm-12 form-hide">
                                <label for="pemantauan_indikator">Indikator (Keluaran)</label>
                                <textarea name="pemantauan_indikator" id="pemantauan_indikator" class="form-control"
                                    rows="5" readonly></textarea>
                            </div>
                            <div class="form-group col-sm-12 form-hide">
                                <label for="pemantauan_periode">Target Waktu</label>
                                <input name="pemantauan_periode" id="pemantauan_periode_waktu" class="form-control" rows="5"
                                    readonly>
                            </div>
                            <div class="form-group col-sm-12 form-hide">
                                <label for="pemantauan_periode_realisasi">Realisasi Waktu</label>
                                <textarea name="pemantauan_periode_realisasi" id="pemantauan_periode_realisasi"
                            ...
                            <div class="form-group col-sm-12 form-hide">
                                ...
                                <input type="hidden" name="pemantauan_hasil[pertanyaan_terjadi]" value="Apakah pernyataan risiko terjadi?">
                                <div class="radio">
                                    <label for="pemantauan_hasilYa">
                                        <input type="radio" name="pemantauan_hasil[terjadi]" id="pemantauan_hasilYa" value="Ya">
                                        Ya
                                    </label>
                                </div>
                                <div class="radio">
                                    <label for="pemantauan_hasilTidak">
                                        <input type="radio" name="pemantauan_hasil[terjadi]" id="pemantauan_hasilTidak" value="Tidak">
                                        Tidak</label>
                                </div>
                            </div>
                            <div class="form-group col-sm-12 form-hide">
                                <label for="pemantauan_hasil[penyebab]">Apakah penyebab risiko terjadi?</label>
                                <input type="hidden" name="pemantauan_hasil[pertanyaan_penyebab]" value="Apakah penyebab risiko terjadi?">
                                <div class="radio">
                                    <label for="penyebabYa">
                                        <input type="radio" name="pemantauan_hasil[penyebab]" id="penyebabYa" value="Ya">
                                        Ya
                                    </label>
                                </div>
                                <div class="radio">
                                    <label for="penyebabTidak">
                                        <input type="radio" name="pemantauan_hasil[penyebab]" id="penyebabTidak" value="Tidak">
                                        Tidak</label>
                                </div>
                            </div>
                            <div class="form-group col-sm-12 form-hide">
                                <label for="pemantauan_hasil[inov]">Apakah inovasi pengendalian dilakukan?</label>
                                <input type="hidden" name="pemantauan_hasil[pertanyaan_inov]" value="Apakah inovasi pengendalian dilakukan?">
                                <div class="radio">
                                    <label for="inovYa">
                                        <input type="radio" name="pemantauan_hasil[inov]" id="inovYa" value="Ya">
                                        Ya
                                    </label>
                                </div>
                                <div class="radio">
                                    <label for="inovTidak">
                                        <input type="radio" name="pemantauan_hasil[inov]" id="inovTidak" value="Tidak">
                                        Tidak</label>
                                </div>
                            </div>
                            <div class="form-group col-sm-12 bukti">
                                <label for="pemantauan_inovasi_file">File Bukti</label>
                                <input type="file" name="pemantauan_inovasi_file" id="pemantauan_inovasi_file" class="form-control" rows="5" accept="application/pdf">
                            ...
                            <div class="form-group col-sm-12 form-hide">
                                ...
                                <input type="hidden" name="pemantauan_hasil[pertanyaan_memadai]" value="Apakah inovasi memadai?">
                                <div class="radio">
                                    <label for="memadaiYa">
                                        <input type="radio" name="pemantauan_hasil[memadai]" id="memadaiYa" value="Ya">
                                        Ya
                                    </label>
                                </div>
                                <div class="radio">
                                    <label for="memadaiTidak">
                                        <input type="radio" name="pemantauan_hasil[memadai]" id="memadaiTidak" value="Tidak">
                                        Tidak</label>
                                </div>
                            </div>
                            <div class="form-group col-sm-12 form-hide">
                                <label for="pemantauan_hasil[respon]"> Apa yang telah dilakukan (diluar rencana inovasi pengendalian)?</label>
                                <input type="hidden" name="pemantauan_hasil[pertanyaan_respon]" value=" Apa yang telah dilakukan (diluar rencana inovasi pengendalian)?">
    ...
    aria-hidden="true" data-backdrop="static">
        <div class="modal-dialog modal-lg">
            <form class="form" id="form-pemantauan_resiko_detail">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="modal-title" id="modal-pemantauan_resiko_detail-title">DAFTAR PEMANTAUAN LEVEL RISIKO
                        </h3>
                    </div>
                    <div class="modal-body">
                        <div class="row">
                                ...
                                <select name="pemantauan_resiko_pernyataan" id="pemantauan_resiko_pernyataan"
                                    ...
                                    @if (isset($data->pernyataan))
                                        @foreach ($data->pernyataan as $item)
                                            <option value="{{ $item->resiko_pernyataan }}" data-resiko_kemungkinan="{{ $item->resiko_kemungkinan }}" data-resiko_dampak="{{ $item->resiko_dampak }}" data-resiko_nilai="{{ $item->resiko_nilai }}">{{ $item->resiko_pernyataan }}</option>
                                        @endforeach
                                    @endif
                                </select>
                            </div>
                            ...
                            <div class="form-group col-sm-12 form-hide">
                                ...
                                <select name="pemantauan_resiko_kemungkinan_act" id="pemantauan_resiko_kemungkinan_act"
                                    class="form-control select2">
                                    <option value="">- Pilih -</option>
                                    @foreach ($data->kriteria_kemungkinan as $item)
                                    <option value="{{ $item->id_kriteria_kemungkinan }}">{{ $item->level_kemungkinan . '-
                            ...
                            <div class="form-group col-sm-12 form-hide">
                                ...
                                <input type="text" name="pemantauan_resiko_nilai_act" id="pemantauan_resiko_nilai_act"
                                    class="form-control" readonly>
                            </div>
                            <div class="form-group col-sm-12 form-hide">
                                <label for="pemantauan_resiko_nilai_capt">Level Risiko </label>
                                <input type="text" name="pemantauan_resiko_nilai_capt" id="pemantauan_resiko_nilai_capt" class="form-control" required readonly>
                            </div>
                            ...
                            <div class="form-group col-sm-12 form-hide">
                                ...
                                <textarea name="pemantauan_resiko_rekomendasi" id="pemantauan_resiko_rekomendasi"
