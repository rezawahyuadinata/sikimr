                    ...
                    <table class="table table-mr">
                        <thead class="label-warning">
                            ...
                            <tr>
                                ...
                                <th colspan="3" class="text-center"
                                    style="vertical-align:middle; border:1px solid white;">LAPORAN PENERAPAN MR TRIWULAN I
                                </th>
                                <th colspan="3" class="text-center"
                                    style="vertical-align:middle; border:1px solid white;">LAPORAN PENERAPAN MR TRIWULAN II
                                </th>
                                <th colspan="3" class="text-center"
                                    style="vertical-align:middle; border:1px solid white;">LAPORAN PENERAPAN MR TRIWULAN III
                                </th>
                                <th colspan="3" class="text-center"
                                    style="vertical-align:middle; border:1px solid white;">LAPORAN PENERAPAN MR TRIWULAN IV
                                </th>
                            </tr>
                            <tr>
        ...
        <div class="col-sm-12">
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <p>History Pengadaan Barang dan Jasa diambil berdasarkan data e-monitoring tanggal terakhir per bulan
                        pukul 16.00 WIB</p>
                </div>
                <div class="box-body">
                    <div class="row">
        ...
        <div class="col-sm-12">
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <p>History Kemajuan Pelaksanaan Lelang diambil berdasarkan data e-monitoring tanggal terakhir per bulan
                        pukul 16.00 WIB</p>
                </div>
                <div class="box-body">
                    <div class="row">
                            ...
                            <table id="table-pengadaan-banding">
                                <thead>
                                    <tr class="text-center text-bold">
                                        ...
                                        <th colspan="2" class="text-center text-bold" style="background-color: grey">
                                            Gagal Lelang</th>
                                    </tr>
                                    <tr class="text-center text-bold">
                                ...
                                <div class="col-sm-12">
                                    <table style="width: 100%" class="text-center">
                                        ...
                                        <tr class="text-bold" style="background-color: black">
                                            ...
                                            <th class="text-right text-white" id="terkontrak-persen-paket-persentase">0%
                                            </th>
                                        </tr>
                                ...
                                <div class="col-sm-12">
                                    <table style="width: 100%" class="text-center">
                                        ...
                                        <tr class="text-bold" style="background-color: black">
                                            ...
                                            <th class="text-right text-white" id="proses-lelang-persen-paket-persentase">
                                                0%</th>
                                        </tr>
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-5">
                                    <div class='input-group date' id='datetimepicker-tahun-status_progress_pekerjaan'>
                                        <input type='text' id="tahun-status_progress_pekerjaan" class="form-control"
                                            value="{{ now()->format('Y') }}" />
                                        <span class="input-group-addon">
                                            <span class="glyphicon glyphicon-calendar"></span>
                                        </span>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class='input-group date' id='datetimepicker-perizinan-terlambat-full-start'>
                                        <input type='text' id="perizinan-terlambat-full-start" class="form-control"
                                            value="{{ now()->firstOfMonth()->format('Y-m-d') }}" />
                                        <span class="input-group-addon">
                                            <span class="glyphicon glyphicon-calendar"></span>
                                        </span>
