...
<html>
    ...
    <body class="hold-transition skin-black layout-top-nav">
        <div class="wrapper">
                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
                            <ul class="nav navbar-nav">
                                @foreach ($data->modul->{$data->page->prefix}->menu as $key => $value)
                                    ...
                                    @foreach ($value->menu as $keys => $values)
                                        @if (! in_array($values->route, ['pemantauan-mr.index', 'tinjauan-mr.index', 'pemantauan-resiko.index']))
                                            <li class="{{ ($key == $data->page->modul && $keys == $data->page->class) ? 'active' : '' }}">
                        ...
                        <div class="navbar-custom-menu">
                            <ul class="nav navbar-nav">
                                {{-- <li class="dropdown">
                                    <select name="active_year" id="active_year" class="form-control select2">
                                ...
                                <li class="dropdown user user-menu">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                        ...
                                        @else
                                            <img src="https://pondokindahmall.co.id/assets/img/default.png" class="user-image" alt="<?php echo $data->user->name; ?>">
                                        @endif
                                    ...
                                    <ul class="dropdown-menu">
                                        <li class="user-header">
                                            ...
                                            @else
                                                <img src="https://pondokindahmall.co.id/assets/img/default.png" class="img-circle" alt="<?php echo $data->user->name; ?>">
                                            @endif
                                            <p>
            ...
            <footer class="main-footer">
                <div class="container">
                    ...
                    <strong>Copyright &copy; 2021 - {{ date('Y') }} </strong>
                </div>  
            </footer>
        </div>
        ...
        <!-- Morris charts -->
        <link rel="stylesheet" href="{{ asset('template') }}/adminlte/bower_components/morris.js/morris.css">
        <!-- Morris.js charts -->
        <script src="{{ asset('template') }}/adminlte/bower_components/raphael/raphael.min.js"></script>
        <script src="{{ asset('template') }}/adminlte/bower_components/morris.js/morris.min.js"></script>
