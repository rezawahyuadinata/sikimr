...
<head>
    ...
    <title>{{ env('APP_NAME_FULL', 'Sistem Informasi Profil Perumahan') }}</title>
...
<body class="hold-transition skin-black layout-top-nav">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown messages-menu manual-book dropdown-menu-right">
                                ...
                                <ul class="dropdown-menu open">
                                    <li>
                                        <a href="{{ url('/storage/manual_book/modul_ki.pdf') }}"
                                            download="Manual Book KI">KI</a>
                                    </li>
                                    <li>
                                        <a href="{{ url('/storage/manual_book/modul_mr.pdf') }}"
    ...
    <script type="text/javascript">
        ...
        var tutorial = '{{ $data->user->tutorial_users == 0 ? true : false }}';
    ...
    @if (isset($data->javascript))
        <script src="{{ asset('js/') }}/{{ $data->javascript }}.js"></script>
    @endif
