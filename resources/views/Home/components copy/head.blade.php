            ...
            <ul class="navbar-nav navbar-nav-hover ms-auto">
                <li class="nav-item dropdown dropdown-hover mx-1 ms-lg-6">
                    <a class="nav-link ps-2 text-dark d-flex cursor-pointer align-items-center "
                        href="{{ route('Welcome') }}" style="font-weight: 500; font-size: 16px;">
                        Beranda
                    </a>
                </li>
                <li class="nav-item dropdown dropdown-hover mx-1">
                    <a class="nav-link ps-2 text-dark d-flex cursor-pointer align-items-center "
                        href="{{ Route('Berita') }}" style="font-weight: 500; font-size: 16px;">
                        Berita
                    </a>
                </li>
                <li class="nav-item dropdown dropdown-hover mx-1 shift">
                    <a class="nav-link ps-2 text-dark d-flex cursor-pointer align-items-center "
                        href="{{ Route('Profil') }}" style="font-weight: 500; font-size: 16px;">
                        Profile
                    </a>
                </li>
                <li class="nav-item dropdown dropdown-hover mx-1 shift">
                ...
                <li class="nav-item dropdown dropdown-hover mx-1 shift">
                    <a class="nav-link ps-2 text-dark d-flex cursor-pointer align-items-center "
                        href="{{ Route('SOP') }}" style="font-weight: 500; font-size: 16px;">
                        SOP
                    </a>
                </li>
                <li class="nav-item dropdown dropdown-hover mx-1">
                    <a class="cursor-pointer btn btn-sm bg-gradient-primary mb-0 me-1 mt-2 mt-md-0"
                        href="{{ Route('Tutorial') }}" style="font-weight: 500; font-size: 16px;">Tutorial</a>
                </li>
                <li class="nav-item dropdown dropdown-hover mx-1">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 my-auto">
                                                <h4 class="text-white m-2 mb-2 fadeIn1 fadeInBottom text-center">
                                                    Laporan Manajemen Risiko {{ date('Y') }}
                                                </h4>
                                ...
                                <div class="page-header rounded min-vh-70">
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-lg-12 my-auto">
                                                <h4 class="text-white m-2 mb-2 fadeIn1 fadeInBottom text-center">
                                                    Laporan Pengadaan Barang dan Jasa {{ date('Y') }}
                                                </h4>
                                                <p class="text-center text-white" style="font-size: 14px"
                                                    id="status_dataPBJ">
                                                </p>
                                ...
                                <div class="page-header rounded min-vh-70">
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-lg-12 my-auto">
                                                <h4 class="text-white m-2 mb-2 fadeIn1 fadeInBottom text-center">
                                                    Laporan Zona Integritas {{ date('Y') }}
                                                </h4>
                                                <p class="text-center text-white" style="font-size: 14px"
                                                    id="status_dataZI">
                                                </p>
                        ...
                        <div class="container">
                            <div class="row my-3">
                                ...
                                <div class="col-md-6 mx-auto text-end">
                                    <a href="{{ route('Berita') }}" class="text-primary icon-move-right">lihat
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-md-6 mx-auto mb-5 text-end">
                                    <a href="{{ route('Tutorial') }}" class="text-primary icon-move-right">lihat
                                        selengkapnya<i class="fas fa-arrow-right text-sm ms-1"></i></a>
                                </div>
                            </div>
