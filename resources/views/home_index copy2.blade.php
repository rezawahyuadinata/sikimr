                    ...
                    <div class="box-body">
                        ...
                        <table class="table">
                            <thead class="label-warning">
                                ...
                                <tr>
                                    <th class="text-center"
                                        style="vertical-align:middle; border:1px solid white; width:5%">V</th>
                                    <th class="text-center"
                                        style="vertical-align:middle; border:1px solid white; width:5%">D</th>
                                    <th class="text-center"
                                        style="vertical-align:middle; border:1px solid white; width:5%">B</th>
                                    <th class="text-center"
                            ...
                            <tbody>
                                ...
                                @endphp
                                @foreach ($data->tingkat_unit as $item)
                                    @if ($item['tingkat'] == Auth::user()->level && $item['unit'] == 'UKER')
                                        @foreach ($data->unit as $items)
                                            @if (!$items->verifikasi)
                                                @php
                                                    $color = '#c50909';
                                                @endphp
                                            @elseif ($items->verifikasi < 3)
                                                @php
                                                    $color = '#d8b802';
                                                @endphp
                                            @else
                                            ...
                                            <tr>
                                                ...
                                                <td style="color: {{ $color }}">{{ $items->NAMA }}</td>
                                                @if (!$items->verifikasi)
                                                    @php
                                                        $b++;
                                                    @endphp
