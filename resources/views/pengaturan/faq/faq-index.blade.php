                    ...
                    <table id="table-data" class="display table table-bordered table-hover" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th data-orderable="true">Pertanyaan</th>
                                <th data-orderable="true">Jawaban</th>
                                <th data-orderable="false"></th>
                            </tr>
                        </thead>
                    </table>
            ...
            <form class="form" id="form-data">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="modal-title" id="modal-data-title">Form Faq</h3>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="form-group col-lg-12 form-hide">
                                ...
                                <textarea class="form-control" name="question" id="question" placeholder="Masukkan pertanyaan"></textarea>
                            </div>
                            <div class="form-group col-lg-12 form-hide">
                                <label for="answer">Jawaban</label>
                                <textarea class="form-control" name="answer" id="answer" placeholder="Masukkan jawaban"></textarea>
                            </div>
                        </div>
                    </div>
