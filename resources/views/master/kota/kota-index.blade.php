...
@section('content')
<div class="row">
    <div class="form-group col-lg-3 col-sm-4 form-hide">
        ...
        <form class="form" id="form-data">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title" id="modal-data-title">Form Kota / Kabupaten</h3>
                </div>
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="form-group col-lg-6 form-hide">
                            <label for="kabupaten_code">Kode</label>
                            <input type="text" class="form-control" name="kabupaten_code" id="kabupaten_code"  placeholder="Masukkan kode kota / kabupaten">
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-lg-12 form-hide">
                            <label for="kabupaten_name">Nama</label>
                            <input type="text" class="form-control" name="kabupaten_name" id="kabupaten_name" placeholder="Masukkan kode kota / kabupaten">
                        </div>
                    </div>
                </div>
