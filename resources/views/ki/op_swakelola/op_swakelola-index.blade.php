                ...
                <table id="table-data" class="display table table-bordered table-hover" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th data-orderable="true">Jumlah Swakelola Non Fisik</th>
                            <th data-orderable="true">Dana Swakelola Non Fisik</th>
                            <th data-orderable="true">Jumlah Swakelola Fisik</th>
                            <th data-orderable="true">Dana Swakelola Fisik</th>
                            ...
                            <th data-orderable="true">Jumlah Kegiatan Wajib Balai</th>
                            <th data-orderable="true">Dana Kegiatan Wajib Balai</th>
        ...
        <form class="form" id="form-data">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title" id="modal-data-title">OP Swakelola</h3>
                </div>
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="form-group col-lg-12 form-hide">
                            <label for="swakelola_non_fisik_jumlah">Jumlah Paket Swakelola Non Fisik</label>
                            <input type="number" class="form-control" name="swakelola_non_fisik_jumlah" id="swakelola_non_fisik_jumlah"
                                placeholder="Masukkan Jumlah Paket Swakelola Non Fisik">
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-lg-12 form-hide">
                            <label for="swakelola_non_fisik_dana">Jumlah Dana Swakelola Non Fisik</label>
                            <input type="number" class="form-control" name="swakelola_non_fisik_dana" id="swakelola_non_fisik_dana"
                                placeholder="Masukkan Jumlah Dana Swakelola Non Fisik">
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-lg-12 form-hide">
                            <label for="swakelola_fisik_jumlah">Jumlah Paket Swakelola Fisik</label>
                            <input type="number" class="form-control" name="swakelola_fisik_jumlah" id="swakelola_fisik_jumlah"
                                placeholder="Masukkan Jumlah Paket Swakelola Fisik">
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-lg-12 form-hide">
                            <label for="swakelola_fisik_dana">Jumlah Dana Swakelola Fisik</label>
                            <input type="number" class="form-control" name="swakelola_fisik_dana" id="swakelola_fisik_dana"
                                placeholder="Masukkan Jumlah Dana Swakelola Fisik">
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-lg-12 form-hide">
                    ...
                    <div class="row">
                        <div class="form-group col-lg-12 form-hide">
                            <label for="kegiatan_wajib_balai_jumlah">Jumlah Paket Kegiatan Wajib Balai</label>
                            <input type="number" class="form-control" name="kegiatan_wajib_balai_jumlah" id="kegiatan_wajib_balai_jumlah"
                                placeholder="Masukkan Jumlah Paket Kegiatan Wajib Balai">
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-lg-12 form-hide">
                            <label for="kegiatan_wajib_balai_dana">Jumlah Dana Kegiatan Wajib Balai</label>
                            <input type="number" class="form-control" name="kegiatan_wajib_balai_dana" id="kegiatan_wajib_balai_dana"
                                placeholder="Masukkan Jumlah Dana Kegiatan Wajib Balai">
                        </div>
                    </div>
