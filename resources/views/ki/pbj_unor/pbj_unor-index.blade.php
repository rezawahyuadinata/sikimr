                ...
                <table id="table-data" class="display table table-bordered table-hover" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th data-orderable="true">Kontrak PKT</th>
                            <th data-orderable="true">Kontrak Pagu Dipa</th>
                            <th data-orderable="true">Kontrak Pagu Pengadaan</th>
        ...
        <form class="form" id="form-data">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title" id="modal-data-title">Form PBJ Unor</h3>
                </div>
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="form-group col-lg-12 form-hide">
                            <label for="KONTRAK_PKT">Kontrak PKT</label>
                            <input type="number" class="form-control" name="KONTRAK_PKT" id="KONTRAK_PKT"
                                placeholder="Masukkan Kontrak PKT">
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-lg-12 form-hide">
                            <label for="KONTRAK_PAGU_DIPA">Kontrak Pagu Dipa</label>
                            <input type="number" class="form-control" name="KONTRAK_PAGU_DIPA" id="KONTRAK_PAGU_DIPA"
                                placeholder="Masukkan Kontrak Pagu Dipa">
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-lg-12 form-hide">
                            <label for="KONTRAK_PAGU_PENGADAAN">Kontrak Pagu Pengadaan</label>
                            <input type="number" class="form-control" name="KONTRAK_PAGU_PENGADAAN"
                                id="KONTRAK_PAGU_PENGADAAN" placeholder="Masukkan Kontrak Pagu Pengadaan">
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-lg-12 form-hide">
