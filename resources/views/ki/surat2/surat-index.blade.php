    ...
    <div class="col-sm-10">
        <div class="card">
            <div class="card-body">
                ...
                <br>
                <button type="button" class="btn btn-primary btn-xs"><i class="fa fa-circle"></i> Deadline </i></button>
                : WAKTU DEADLINE LEBIH DARI 5 HARI,&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <button type="button" class="btn btn-warning btn-xs"><i class="fa fa-warning"> Deadline </i></button>
                : WAKTU DEADLINE KURANG DARI 5 HARI,&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <button type="button" class="btn btn-danger btn-xs"><i class="fa fa-exclamation-circle"> Deadline </i></button>
                : WAKTU DEADLINE KURANG DARI 1 HARI
                <br>
                <small>*Informasi Peringatan Menyesuaikan Dengan Deadline Status Pengumpulan Data MD (Waktu)</small>
            </div>
        </div>
    </div>
</div>
                ...
                <table id="table-data" class="display table table-striped table-hover datatable" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th data-orderable="true">Status Pengumpulan Data MD (Proses)</th>
                            <th data-orderable="true">Status Pengumpulan Data MD (Waktu)</th>
                            <th data-orderable="true">Status TL Nota Dinas</th>
                            <th data-orderable="false" width="80px;">Peringatan</th>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group col-lg-3 form-hide">
                        ...
                        <div class="form-group col-lg-12 form-hide">
                            <label for="perihal">Unit Pengirim*</label>
                            <input type="text" class="form-control" name="unit_pengirim" id="unit_pengirim"
                                placeholder="Masukkan perihal">
                        </div>
