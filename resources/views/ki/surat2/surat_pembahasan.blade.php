            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-lg-12 form-hide">
                            <label for="catatan">Point Pengaduan</label>
                            <textarea type="text" class="form-control" name="poin_pengaduan" id="poin_pengaduan" placeholder="Masukan Poin pengaduan"></textarea>
                        </div>
                        <div class="form-group col-lg-6 form-hide">
