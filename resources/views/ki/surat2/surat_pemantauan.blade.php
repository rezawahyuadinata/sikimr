<div class="row">
    ...
    <div class="form-group col-sm-2">
        <!-- <a href="" target="_blank">TEASASASASASASAST</a> -->
        <button class="btn btn-primary btn-block"
            onclick="addData('#modal-pemantauan', '#form-pemantauan')">Tambah
        </button>
    </div>
</div>
<div class="row">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-lg-6 form-hide">
                            ...
                            <?php 
                                use Carbon\Carbon;
                                $bataswaktu = App\Model\Master\TelaahanModel::select('tanggal')->where('id_surat',request('id'))->where('deleted_at',NULL)->orderby('id', 'desc')->pluck('tanggal')->first();
                                $bataswaktu = Carbon::parse($bataswaktu)->addDays(14);
                            ?>
                            <input type="text" class="form-control" name="tgl_batas_waktu" value="{{$bataswaktu}}" id="tgl_batas_waktu" readonly>
                        </div>
                        <div class="form-group col-lg-3 form-hide">
                            <label for="tanggal">Tanggal Sekarang* </label>
                            <br>
                            @if(\Carbon\Carbon::parse($bataswaktu)->lt(\Carbon\Carbon::now()))
                            <j class="text-red"><?php echo date("d/m/Y") ;?></j>
                            @else
                        ...
                        <div class="form-group col-lg-3 form-hide">
                            ...
                            <?php 
                                ...
                                {
                                    $statustl = "Waktu Habis";
                                }
                                else if(Carbon::parse($bataswaktu)->lt(Carbon::now()))
                                {
                                    $tanggalTL = Carbon::parse($bataswaktu);
                            ...
                            ?>
                            @if(\Carbon\Carbon::parse($bataswaktu)->lt(\Carbon\Carbon::now()))
                            <j2 class="text-red"><?php echo $statustl ;?></j2>
                            @else
                            <?php echo $statustl ;?>
                            @endif
                        </div>
