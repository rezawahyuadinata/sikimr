                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-lg-12 form-hide">
                            ...
                            <textarea type="text" class="form-control" name="rekomendasi" id="rekomendasi"
                                placeholder="Masukkan Rekomendasi" rows="5" cols="100"></textarea>
                        </div>
                        <div class="form-group col-lg-6 form-hide">
                        ...
                        <div class="form-group col-lg-12 form-hide">
                            ...
                            <textarea type="text" class="form-control" name="key_telaahan" id="key_telaahan"
