            ...
            <div class="box">
                <div class="box-body">
                    <div class="row">
                        <div class="col-xs-12 col-sm-3">
                            ...
                            <div class='input-group date' id='datetimepicker-tahun_backup'>
                                <input type='text' id="tahun_backup" class="form-control"
                                    value="{{ now()->format('Y') }}" />
                    ...
                    <div class="row" style="margin-bottom: 50px">
                        {{-- catatan: <div class="col-xs-12 col-sm-3">
                    ...
                    <table id="table-data" class="display table table-bordered table-hover" width="100%">
                        <thead>
                            ...
                            <tr>
                                ...
                                {{-- catatan: <th data-orderable="true" class="text-center">NPWP</th> --}}
                                <th data-orderable="true" class="text-center">Nomor Kontrak</th>
                                <th data-orderable="true" class="text-center">Tanggal Kontrak</th>
                                {{-- catatan: <th data-orderable="true" class="text-center">Tanggal SPMK</th> --}}
                                {{-- catatan: <th data-orderable="true" class="text-center">Durasi Waktu Hari</th> --}}
