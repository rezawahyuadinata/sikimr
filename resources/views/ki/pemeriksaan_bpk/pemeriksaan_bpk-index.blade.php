                    ...
                    <table id="table-data" class="display table table-bordered table-hover" width="100%">
                        <thead>
                            <tr>
                                ...
                                {{-- catatan: <th data-orderable="true" rowspan="3">Tanggal</th> --}}
                                {{-- catatan: <th data-orderable="true" rowspan="3">Unor</th> --}}
                                <th data-orderable="true" rowspan="3">Nomor LHP BPK</th>
                                {{-- catatan: <th data-orderable="true" rowspan="3">Tahun</th>
                            <th data-orderable="true" rowspan="3">Jenis LHP</th> --}}
                                <th data-orderable="false" colspan="2" rowspan="2">Rekomendasi</th>
                                <th data-orderable="false" colspan="8" class="text-center">Status Tindak Lanjut
                                    Rekomendasi Hasil Pemeriksaan BPK RI</th>
                                {{-- catatan: <th data-orderable="true" rowspan="3">Deskripsi Tindak Lanjut</th> --}}

                                {{-- catatan: <th data-orderable="false" rowspan="3"></th> --}}
                            </tr>
                            <tr>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="form-group col-lg-12 form-hide">
                                ...
                                <input type="text" class="form-control" name="nomor_lhp_bpk" id="nomor_lhp_bpk"
                        ...
                        <div class="row">
                            <div class="form-group col-lg-12 form-hide">
                                ...
                                <input type="number" class="form-control" name="rekomendasi_jumlah" id="rekomendasi_jumlah"
                        ...
                        <div class="row">
                            <div class="form-group col-lg-12 form-hide">
                                ...
                                <input type="number" class="form-control" name="rekomendasi_nilai" id="rekomendasi_nilai"
                        ...
                        <div class="row">
                            <div class="form-group col-lg-12 form-hide">
                                ...
                                <input type="number" class="form-control" name="tindak_lanjut_sesuai_rekomendasi_jumlah"
                                    id="tindak_lanjut_sesuai_rekomendasi_jumlah" placeholder="Masukkan Jumlah">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-lg-12 form-hide">
                                <label for="tindak_lanjut_sesuai_rekomendasi_nilai">Nilai</label>
                                <input type="number" class="form-control" name="tindak_lanjut_sesuai_rekomendasi_nilai"
                                    id="tindak_lanjut_sesuai_rekomendasi_nilai" placeholder="Masukkan Nilai">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group col-lg-12 form-hide">
                                ...
                                <input type="number" class="form-control"
                                    name="tindak_lanjut_belum_sesuai_rekomendasi_jumlah"
                                    id="tindak_lanjut_belum_sesuai_rekomendasi_jumlah" placeholder="Masukkan Jumlah">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-lg-12 form-hide">
                                ...
                                <input type="number" class="form-control"
                                    name="tindak_lanjut_belum_sesuai_rekomendasi_nilai"
                                    id="tindak_lanjut_belum_sesuai_rekomendasi_nilai" placeholder="Masukkan Nilai">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group col-lg-12 form-hide">
                                ...
                                <input type="number" class="form-control"
                                    name="tindak_lanjut_belum_ditindaklanjuti_rekomendasi_jumlah"
                                    id="tindak_lanjut_belum_ditindaklanjuti_rekomendasi_jumlah"
                                    placeholder="Masukkan Jumlah">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-lg-12 form-hide">
                                ...
                                <input type="number" class="form-control"
                                    name="tindak_lanjut_belum_ditindaklanjuti_rekomendasi_nilai"
                                    id="tindak_lanjut_belum_ditindaklanjuti_rekomendasi_nilai" placeholder="Nilai">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group col-lg-12 form-hide">
                                ...
                                <input type="number" class="form-control"
                                    name="tindak_lanjut_tidak_dapat_ditindaklanjuti_rekomendasi_jumlah"
                                    id="tindak_lanjut_tidak_dapat_ditindaklanjuti_rekomendasi_jumlah"
                                    placeholder="Masukkan Jumlah">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-lg-12 form-hide">
                                ...
                                <input type="number" class="form-control"
                                    name="tindak_lanjut_tidak_dapat_ditindaklanjuti_rekomendasi_nilai"
                                    id="tindak_lanjut_tidak_dapat_ditindaklanjuti_rekomendasi_nilai"
                                    placeholder="Masukkan Nilai">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-lg-12 form-hide">
                                ...
                                <input type="text" class="form-control" name="deskripsi_tindak_lanjut"
                                    id="deskripsi_tindak_lanjut" placeholder="Masukkan Deskripsi">
                            </div>
                        </div>
                    </div>
