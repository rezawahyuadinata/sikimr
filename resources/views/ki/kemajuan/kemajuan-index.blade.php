...
@section('content')
    ...
    <div class="row">
        {{-- catatan: <div class="form-group col-sm-2">
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <select name="pengadaan-banding1" id="pengadaan-banding1"
                                        class="form-control select2 change-draw"></select>
                                </div>
                                <div class="col-sm-6">
                                    <select name="pengadaan-banding2" id="pengadaan-banding2"
                                        class="form-control select2 change-draw"></select>
                                </div>
                            </div>
                        </div>
                                ...
                                <table id="table-pengadaan-banding" class="table table-hover table-striped">
                                    <thead style="position: sticky; top:0">
                                        <tr class="text-center text-bold">
                                            <td rowspan="3" class="text-center text-bold"
                                                style="background-color: #009999">UPT</td>
                                            <td colspan="12" id="table-date1">11 Desember</td>
                                            <td colspan="12" id="table-date2" style="background-color: #d1d6ff">11
                                                Desember</td>
                                        </tr>
                                        <tr class="text-center text-bold">
                                            ...
                                            <td colspan="2" class="text-center text-bold" style="background-color: grey">
                                                Gagal Lelang</th>
                                            <td colspan="2" class="text-center text-bold"
                                                style="background-color: #009999">Kontraktual</th>
                                            <td colspan="2" class="text-center text-bold"
