        ...
        <div class="box">
            <div class="box-body">
                <table id="table-data" class="display table table-bordered table-hover" width="100%">
                    <thead>
                        <tr><center>
                            <th data-orderable="false"  colspan="15" style="background-color: green;"><center>DATABASE</center></th>
                            <th data-orderable="false"  colspan="10" style="background-color: pink;"><center>STATUS SIPTL</center></th>
                            <th data-orderable="false"  colspan="4" style="background-color: orange;"><center>VERIFIKASI ITJEN</center></th>
                            <th data-orderable="false"  colspan="8" style="background-color: gray;"><center>TINDAK LANJUT BARU YANG AKAN DIAJUKAN VERIFIKASI KE ITJEN</center></th>
                            <th data-orderable="false"  colspan="4" style="background-color: yellow;"><center>JANGKA WAKTU PENYELESAIAN TLRHP BPK RI</center></th>
                            <th data-orderable="false"  colspan="6" style="background-color: yellow;"><center>KLASIFIKASI RENAKSI</center></th>		
                        </tr>
                        <tr>
    ...
    <div class="modal-dialog">
      ...
      <!-- header-->
        ...
        <div class="modal-body">
          <form>
            <input type="hidden" class="form-control" name="token" id="token_excel" value="{{csrf_token()}}">
            <div class="form-group">
                <label for="file">Upload File</label>
                <input type="file" class="form-control" name="file" id="file_excel" placeholder="Input File .xls">
            </div>
          </form>
          <br>
          <br>
          <a  class="btn btn-primary" href="{{url('')}}/ki/template/pemantauan_bpk/download">Download Template</a>
        </div>
        <!--footer-->
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="form-group col-lg-6 form-hide">
                            ...
                            <input type="text" class="form-control" name="judul_matriks" id="judul_matriks" placeholder="Masukkan judul_matriksR">
                        </div>
                    
                        <div class="form-group col-lg-6 form-hide">
                            <label for="no_lhp">Nomor LHP BPK</label>
                            <input type="text" class="form-control" name="no_lhp" id="no_lhp" placeholder="Masukkan Nomor LHP BPK">
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-lg-6 form-hide">
                            <label for="jenis_lhp">JENIS LHP</label>
                            <input type="text" class="form-control" name="jenis_lhp" id="jenis_lhp" placeholder="Masukkan Tahun">
                        </div>
                    
                        <div class="form-group col-lg-6 form-hide">
                            <label for="jenis_temuan">JENIS TEMUAN</label>
                            <input type="text" class="form-control" name="jenis_temuan" id="jenis_temuan" placeholder="Masukkan Jenis Temuan">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-lg-6 form-hide">
                            ...
                            <input type="text" class="form-control" name="reff_lhp" id="reff_lhp" placeholder="Masukkan reff_lhp">
                        </div>
                    
                        <div class="form-group col-lg-6 form-hide">
                            <label for="ref_idt">REFF IDT</label>
                            <input type="text" class="form-control" name="ref_idt" id="ref_idt" placeholder="Masukkan ref_idt">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-lg-2 form-hide">
                            ...
                            <input type="number" class="form-control" name="tahun_lhp" id="tahun_lhp" placeholder="Masukkan tahun_lhp">
                        </div>
                    
                        <div class="form-group col-lg-10 form-hide">
                            <label for="judul_temuan_besar">JUDUL TEMUAN BESAR</label>
                            <input type="text" class="form-control" name="judul_temuan_besar" id="judul_temuan_besar" placeholder="Masukkan judul_temuan_besar" row="3">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-lg-12 form-hide">
                            ...
                            <input type="text" class="form-control" name="rekomendasi_temuan" id="rekomendasi_temuan" placeholder="Masukkan rekomendasi_temuan">
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-lg-4 form-hide">
                            <label for="unit_organisasi">UNIT ORGANISASI</label>
                            <input type="text" class="form-control" name="unit_organisasi" id="unit_organisasi" placeholder="Masukkan unit_organisasi">
                        </div>
                        <div class="form-group col-lg-3 form-hide">
                            ...
                            <select name="upt_id" id="upt_id" class="form-control select2 unitkerja">
                                ...
                                @foreach (DB::table('eselon-2')->get() as $item)
                                    <option value="{{ $item->ID }}" data-pejabat="{{ $item->PEJABAT }}" data-jabatan="{{ $item->JABATAN }}" data-nip="{{ $item->NIP }}">{{ $item->NAMA }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group col-lg-3 form-hide">
                        ...
                        <div class="form-group col-lg-2 form-hide">
                         ...
                         <div class="form-group col-lg-3 form-hide">
                            ...
                            <input type="number" class="form-control" name="nilai_rekomendasi" id="nilai_rekomendasi" placeholder="Masukkan nilai_rekomendasi">
                        </div>
                    </div>
                    <hr>
                    <!-- STATUS SIPTL -->
                    ...
                    <div class="row">
                        <div class="form-group col-lg-4 form-hide">
                            ...
                            <input type="number" class="form-control" name="nilai_ss" id="nilai_ss" placeholder="Masukkan nilai_ss">
                        </div>
                        <div class="form-group col-lg-4 form-hide">
                            <label for="nilai_tptd">NILAI TPTD</label>
                            <input type="text" class="form-control" name="nilai_tptd" id="nilai_tptd" placeholder="Masukkan nilai_tptd">
                        </div>
                        <div class="form-group col-lg-4 form-hide">
                            <label for="nilai_sisa">NILAI SISA</label>
                            <input type="text" class="form-control" name="nilai_sisa" id="nilai_sisa" placeholder="Masukkan nilai_sisa">
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-lg-12 form-hide">
                            <label for="uraian_tl_bpk">URAIAN TINDAK LANJUT BPK</label>
                            <input type="text" class="form-control" name="uraian_tl_bpk" id="uraian_tl_bpk" placeholder="Masukkan uraian_tl_bpk">
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-lg-3 form-hide">
                        ...
                        <div class="form-group col-lg-6 form-hide">
                            ...
                            <select name="status_tekomendasi_unor" id="status_tekomendasi_unor" class="form-control select2">
                        ...
                        <div class="form-group col-lg-6 form-hide">
                            ...
                            <input type="text" class="form-control" name="uraian_kekurangan_tl" id="uraian_kekurangan_tl" placeholder="Masukkan uraian_kekurangan_tl">
                        </div>
                        <div class="form-group col-lg-6 form-hide">
                            <label for="status_upload_siptl">STATUS UPLOAD SIPTL</label>
                            <input type="text" class="form-control" name="status_upload_siptl" id="status_upload_siptl" placeholder="Masukkan status_upload_siptl">
                        </div>
                    
                        <div class="form-group col-lg-6 form-hide">
                            <label for="status_finalisasi_siptl">STATUS FINALISASI SIPTL</label>
                            <input type="text" class="form-control" name="status_finalisasi_siptl" id="status_finalisasi_siptl" placeholder="Masukkan status_finalisasi_siptl">
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-lg-12 form-hide">
                            <label for="uraian_kekurangan_dokumen">URAIAN KEKURANGAN  DOKUMEN UPLOAD</label>
                            <input type="text" class="form-control" name="uraian_kekurangan_dokumen" id="uraian_kekurangan_dokumen" placeholder="Masukkan uraian kekurangan_dokumen">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-lg-12 form-hide">
                            ...
                            <input type="text" class="form-control" name="uraian_verifikasi" id="uraian_verifikasi" placeholder="Masukkan uraian_verifikasi">
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-lg-6 form-hide">
                            <label for="nilai_memadai">NILAI MEMADAI</label>
                            <input type="text" class="form-control" name="nilai_memadai" id="nilai_memadai" placeholder="Masukkan nilai_memadai">
                        </div>
                    ...
                    <div class="row">
                        <div class="form-group col-lg-12 form-hide">
                            ...
                            <input type="text" class="form-control" name="catatan_belum_memadai" id="catatan_belum_memadai" placeholder="Masukkan catatan_belum_memadai">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-lg-10 form-hide">
                            ...
                            <input type="text" class="form-control" name="tl_baru_diajukan_verifikasi_itjen" id="tl_baru_diajukan_verifikasi_itjen" placeholder="Masukkan tl_baru_diajukan_verifikasi_itjen">
                        </div>
                   
                        <div class="form-group col-lg-2 form-hide">
                            <label for="nilai_tl_baru_diajukan_itjen">NILAI </label>
                            <input type="text" class="form-control" name="nilai_tl_baru_diajukan_itjen" id="nilai_tl_baru_diajukan_itjen" placeholder="Masukkan nilai_tl_baru_diajukan_itjen">
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-lg-10 form-hide">
                            <label for="tl_baru_validasi_uki">TL BARU VALIDASI UKI</label>
                            <input type="text" class="form-control" name="tl_baru_validasi_uki" id="tl_baru_validasi_uki" placeholder="Masukkan tl_baru_validasi_uki">
                        </div>
                    
                        <div class="form-group col-lg-2 form-hide">
                            <label for="nilai_tl_baru_validasi_uki">NILAI </label>
                            <input type="text" class="form-control" name="nilai_tl_baru_validasi_uki" id="nilai_tl_baru_validasi_uki" placeholder="Masukkan nilai_tl_baru_validasi_uki">
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-lg-2 form-hide">
                            <label for="nilai_total_tl">NILAI TOTAL TINDAK LANJUT</label>
                            <input type="text" class="form-control" name="nilai_total_tl" id="nilai_total_tl" placeholder="Masukkan nilai_total_tl">
                        </div>
                        ...
                        <div class="form-group col-lg-8 form-hide">
                            ...
                            <input type="text" class="form-control" name="sifat_rekomendasi" id="sifat_rekomendasi" placeholder="Masukkan sifat_rekomendasi">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-lg-12 form-hide">
                            ...
                            <input type="text" class="form-control" name="rencana_aksi" id="rencana_aksi" placeholder="Masukkan rencana_aksi">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-lg-3 form-hide">
                            ...
                            <input type="date" class="form-control" name="duedate_renaksi" id="duedate_renaksi" placeholder="Masukkan duedate_renaksi">
                        </div>
                   
                        <div class="form-group col-lg-3 form-hide">
                            <label for="penyelesaian_bpk_pendek">Pendek (< 1 bulan)</label>
                            <input type="text" class="form-control" name="penyelesaian_bpk_pendek" id="penyelesaian_bpk_pendek" placeholder="Masukkan penyelesaian_bpk_pendek">
                        </div>
                   
                        <div class="form-group col-lg-3 form-hide">
                            <label for="penyelesaian_bpk_menengah">Menengah (1 sd 3 bln)</label>
                            <input type="text" class="form-control" name="penyelesaian_bpk_menengah" id="penyelesaian_bpk_menengah" placeholder="Masukkan penyelesaian_bpk_menengah">
                        </div>
                    
                        <div class="form-group col-lg-3 form-hide">
                            <label for="penyelesaian_bpk_panjang">Panjang (lebih dari 3 bulan)</label>
                            <input type="text" class="form-control" name="penyelesaian_bpk_panjang" id="penyelesaian_bpk_panjang" placeholder="Masukkan penyelesaian_bpk_panjang">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-lg-12 form-hide">
                            ...
                            <input type="text" class="form-control" name="klasren_dapat_tl" id="klasren_dapat_tl" placeholder="Masukkan klasren_dapat_tl">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-lg-12 form-hide">
                            ...
                            <input type="text" class="form-control" name="klasren_pembahasan_tl" id="klasren_pembahasan_tl" placeholder="Masukkan klasren_pembahasan_tl">
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-lg-12 form-hide">
                            <label for="klasren_tptd">TPTD</label>
                            <input type="text" class="form-control" name="klasren_tptd" id="klasren_tptd" placeholder="Masukkan klasren_tptd">
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-lg-12 form-hide">
                            <label for="klasren_tl_disepakati">Tindak Lanjut Telah Disepakati Bersama BPK RI</label>
                            <input type="text" class="form-control" name="klasren_tl_disepakati" id="klasren_tl_disepakati" placeholder="Masukkan klasren_tl_disepakati">
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-lg-12 form-hide">
                            <label for="klasren_tptd">Dalam Proses Telaah BPK RI</label>
                            <input type="text" class="form-control" name="klasren_proses_telaah" id="klasren_proses_telaah" placeholder="Masukkan klasren_proses_telaah">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-lg-12 form-hide">
                            ...
                            <input type="text" class="form-control" name="pejabat_terkait" id="pejabat_terkait" placeholder="Masukkan pejabat_terkait">
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-lg-12 form-hide">
                            <label for="catatan_pembahasan">Catatan Pembahasan</label>
                            <input type="text" class="form-control" name="catatan_pembahasan" id="catatan_pembahasan" placeholder="Masukkan catatan_pembahasan">
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-lg-12 form-hide">
                            <label for="tl_sebelum_khp">TL sebelum KHP</label>
                            <input type="text" class="form-control" name="tl_sebelum_khp" id="tl_sebelum_khp" placeholder="Masukkan tl_sebelum_khp">
                        </div>
                    </div>
