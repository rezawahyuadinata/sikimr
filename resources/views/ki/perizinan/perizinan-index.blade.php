                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            ...
                            <div class='input-group date' id='datetimepicker-perizinan-start'>
                                <input type='text' id="perizinan-start" class="form-control change-draw"
                        ...
                        <div class="col-sm-3">
                            ...
                            <div class='input-group date' id='datetimepicker-perizinan-end'>
                                <input type='text' id="perizinan-end" class="form-control change-draw"
                    ...
                    <table id="table-data" class="display table table-bordered table-hover" width="100%">
                        <thead>
                            <tr>
                                ...
                                {{-- catatan: <th data-orderable="true" >Tanggal Tanggal Pengajuan Permohonan Izin</th> --}}
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-12 form-hide">
                                ...
                                <input type="number" class="form-control" name="volume_yang_diizinkan"
                                    id="volume_yang_diizinkan" placeholder="Masukkan Volume Yang diizinkan">
                            </div>
                            <div class="form-group col-lg-12 form-hide">
                            ...
                            <div class="form-group col-lg-12 form-hide">
                                ...
                                <input type="text" class="form-control" name="nama_perusahaan" id="nama_perusahaan"
                                    placeholder="Masukkan Perusahaan Pemohon">
                            </div>
                            <div class="form-group col-lg-12 form-hide">
                                <label for="sumber_air">Sumber Air</label>
                                <input type="text" class="form-control" name="sumber_air" id="sumber_air"
                                    placeholder="Masukkan Sumber Air">
                            </div>
                            <div class="form-group col-lg-12 form-hide">
                                <label for="nama_balai">Nama Balai</label>
                                <input type="text" class="form-control" name="nama_balai" id="nama_balai"
                                    placeholder="Masukkan Nama Balai">
                            </div>
                            <div class="form-group col-lg-12 form-hide">
                                <label for="jenis_permohonan_edit">Jenis Permohonan</label>
                                <select name="jenis_permohonan_edit" id="jenis_permohonan_edit"
                            ...
                            <div class="form-group col-lg-12 form-hide form-monev">
                                ...
                                <div class='input-group date' id='datetimepicker-tanggal_monev'>
                                    <input type='text' id="tanggal_monev" class="form-control" name='tanggal_monev'
                                        value="{{ date('Y-m-d') }}" />
                                    <span class="input-group-addon">
                                        <span class="glyphicon glyphicon-calendar"></span>
                                    </span>
                            ...
                            <div class="form-group col-lg-12 form-hide status_monev_sudah">
                                ...
                                <input type="file" name="dokumen_hasil_monev" id="dokumen_hasil_monev"
                                    class="form-control">
                        ...
                        <div class="row">
                            <div class="form-group col-lg-12 form-hide">
                                <a href='{{ url('ki/surat') }}' target="_blank"
                                    class="btn btn-primary btn-pengaduan">Masukkan Data Pengaduan</a>
                            </div>
                        </div>
                    </div>
