...
function setDataTable(divId, dataUrl, colDef = [], requestData = null, requestOrder = null, reqDom = null, reqFooterCallback = null, reqButton = true, reqCreatedRow = false) {
  var tableConf = {
    select: true,
    scrollX: true,
    scrollY: '500px',
  ...
  if (reqCreatedRow != false) {
    tableConf.createdRow = reqCreatedRow;
  }
...
function cancelVerification(id, actionUrl, callback = refresh, message = "Anda yakin akan membatalkan data verifikasi tersebut?") {
  swal({
    title: "Peringatan!",
    text: message,
    type: "warning",
...
function formatCurrency(data, digits = 0) {
