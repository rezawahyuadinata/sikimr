...
function detailData(id) {
    ...
    toggleForm('#form-data-edit', roleUpdate);
    resetForm('#form-data-edit');

    $('#id_sop').val(data[0].id);
    $('#modal-data-edit').modal('show');
}
...
$(document).ready(function () {
    ...
    $('#form-data-edit').validate({
        ...
        submitHandler: function (form) {
            ...
            ajaxData(urlAction, reqData, refresh, true, true, 'post');
        }
    });
});
