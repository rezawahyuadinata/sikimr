...
function detailData(id) {
    ...
    $('#swakelola_non_fisik_jumlah').val(data[0].swakelola_non_fisik_jumlah);
    $('#swakelola_non_fisik_dana').val(data[0].swakelola_non_fisik_dana);
    $('#swakelola_fisik_jumlah').val(data[0].swakelola_fisik_jumlah);
    $('#swakelola_fisik_dana').val(data[0].swakelola_fisik_dana);
    ...
    $('#kegiatan_wajib_balai_jumlah').val(data[0].kegiatan_wajib_balai_jumlah);
    $('#kegiatan_wajib_balai_dana').val(data[0].kegiatan_wajib_balai_dana);
...
function setTable() {
    var colDef = [
        ...
        { data: 'swakelola_non_fisik_jumlah' },
        { data: 'swakelola_non_fisik_dana' },
        { data: 'swakelola_fisik_jumlah' },
        { data: 'swakelola_fisik_dana' },
        ...
        { data: 'kegiatan_wajib_balai_jumlah' },
        { data: 'kegiatan_wajib_balai_dana' },
