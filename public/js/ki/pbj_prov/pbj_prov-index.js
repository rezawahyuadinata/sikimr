...
function detailData(id) {
    ...
    $('#id').val(data[0].id);
    $('#provinsi').val(data[0].provinsi).trigger('change');
    $('#TOTAL_KONTRAK_PKT').val(data[0].TOTAL_KONTRAK_PKT);
    $('#TOTAL_KONTRAK_PAGU_DIPA').val(data[0].TOTAL_KONTRAK_PAGU_DIPA);
    $('#TOTAL_KONTRAK_PAGU_PENGADAAN').val(data[0].TOTAL_KONTRAK_PAGU_PENGADAAN);
...
function setTable() {
    var colDef = [
        ...
        {data: 'provinsi'},
        {data: 'TOTAL_KONTRAK_PKT'},
        {data: 'TOTAL_KONTRAK_PAGU_DIPA'},
        {data: 'TOTAL_KONTRAK_PAGU_PENGADAAN'},
        {data: 'TERKONTRAK_PKT'},
