...
--
-- Table structure for table `m_dampak`
--

CREATE TABLE `m_dampak` (
  `id_dampak` int(11) NOT NULL,
  `dampak` varchar(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `m_dampak`
--

INSERT INTO `m_dampak` (`id_dampak`, `dampak`) VALUES
(1, '1. Keuangan Negara'),
(2, '2. Reputasi'),
(3, '3. Hukum'),
(4, '4. Kecelakaan dan Penyakit Akibat Kerja'),
(5, '5. Gangguan Layanan Organisasi'),
(6, '6. Penurunan Kinerja');
...
--
-- Indexes for table `m_dampak`
--
ALTER TABLE `m_dampak`
...
--
-- AUTO_INCREMENT for table `m_dampak`
--
ALTER TABLE `m_dampak`
  MODIFY `id_dampak` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
COMMIT;
